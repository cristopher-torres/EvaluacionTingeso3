    ...
    <Box sx={{ p: 3, bgcolor: '#0f172a', minHeight: '100vh' }}>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText sx={{ color: '#cbd5e1' }}>
            ¿Está seguro que desea dar de baja la herramienta <strong>{selectedTool?.name}</strong>?
            Esta acción lo removerá permanentemente del flujo de préstamos.
          </DialogContentText>
        </DialogContent>
        <DialogActions sx={{ p: 3 }}>
          <Button onClick={handleCloseConfirm} sx={{ color: '#94a3b8', textTransform: 'none' }}>
            Cancelar
          </Button>
          <Button
      ...
      >
        <Alert
          variant="filled"
          severity="success"
          sx={{ bgcolor: '#0ea5e9', color: '#0f172a', fontWeight: 700 }}
        >
          {snackbarMsg}
        </Alert>
      </Snackbar>
