    ...
    <Box sx={{ p: 3, bgcolor: '#0f172a', minHeight: '100vh' }}>
          ...
          <TableBody>
            {filteredLoans.map((loan) => (
              ...
              >
                ...
                <TableCell sx={{ color: '#f87171', fontWeight: 700 }}>
                  ${loan.fineTotal}
                </TableCell>
                <TableCell>
                  <Button
                    ...
                    sx={skyButtonStyle}
                    size="small"
                    onClick={() => handleOpenConfirmDialog(loan)}
                  >
                    Marcar Pago
                  </Button>
                </TableCell>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText sx={{ color: '#cbd5e1' }}>
            ¿Confirma que el cliente con RUT <strong>{loanToPay?.client?.rut}</strong> ha cancelado la
            totalidad de la multa por <strong>${loanToPay?.fineTotal}</strong>?
          </DialogContentText>
        </DialogContent>
        <DialogActions sx={{ p: 3, borderTop: '1px solid rgba(148, 163, 184, 0.1)' }}>
          ...
          <Button onClick={confirmPayment} variant="contained" sx={skyButtonStyle}>
            Validar Pago
          </Button>
        </DialogActions>
      </Dialog>
      ...
      >
        <Alert
          ...
          variant="filled"
          sx={{
            bgcolor: severity === 'success' ? '#0ea5e9' : '#f87171',
            color: severity === 'success' ? '#0f172a' : 'white',
            fontWeight: 700,
          }}
        >
          {snackbarMsg}
