...
const ActiveLoanList = () => {
  ...
  const handleCloseReceiptAndRefresh = () => {
    setOpenReceiptDialog(false);
    setSelectedLoan(null);
    fetchAllLoans();
  };
      ...
      <Box sx={{ p: 3, bgcolor: '#0f172a', minHeight: '100vh' }}>
        ...
        >
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 4, flexWrap: 'wrap' }}>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
              <Typography variant="overline" sx={{ color: '#38bdf8', fontWeight: 600, letterSpacing: '0.05em' }}>
                Filtros de fecha
              </Typography>
        ...
        >
          ...
          <DialogContent>
            <Box sx={{ mt: 1, display: 'flex', flexDirection: 'column', gap: 1 }}>
              <Typography variant="body2" sx={{ color: '#94a3b8', mb: 1 }}>
                Marque las condiciones de entrega:
              </Typography>
              <FormControlLabel
                control={
                  <Checkbox
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    sx={{ color: '#475569', '&.Mui-checked': { color: '#f87171' } }}
                    checked={irreparable}
                ...
                label={
                  <Typography sx={{ color: damaged ? '#e2e8f0' : '#475569' }}>
                    El daño es irreparable (reposición total)
                  </Typography>
                }
              />
            </Box>
          ...
          <DialogActions sx={{ p: 2.5, borderTop: '1px solid rgba(148, 163, 184, 0.1)' }}>
            ...
            <Button variant="contained" sx={skyButtonStyle} onClick={handleReturn}>
            ...
            {loanReceipt && (
              <Box sx={{ mt: 1 }}>
                ...
                >
                  ...
                  <Typography
                    variant="body2"
                    sx={{ color: loanReceipt.fine > 0 ? '#f87171' : '#e2e8f0' }}
                  >
                    $
                    {loanReceipt.fine || '0'}
                  </Typography>
                ...
                >
                  ...
                  <Typography
                    variant="body2"
                    sx={{ color: loanReceipt.damagePrice > 0 ? '#f87171' : '#e2e8f0' }}
                  >
                    $
                    {loanReceipt.damagePrice || '0'}
                  </Typography>
                </Box>
                ...
                {loanReceipt.fineTotal > 0 ? (
                  ...
                  >
                    ...
                    >
                      ¿Se liquidó la deuda en este momento?
                    </Typography>
                    <Box display="flex" gap={2}>
                      <Button
                        fullWidth
                        sx={{ ...skyButtonStyle, bgcolor: 'rgba(56, 189, 248, 0.1)' }}
                        variant="contained"
                  ...
                  <Box display="flex" justifyContent="center" mt={2}>
                    <Button
                      variant="contained"
                      sx={{ ...skyButtonStyle, width: '100%', py: 1.2 }}
                      onClick={handleCloseReceiptAndRefresh}
                    >
                      Cerrar Boleta
                    </Button>
                  </Box>
