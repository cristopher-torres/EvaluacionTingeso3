    ...
    >
      ...
      <List>
        ...
        <ListItemButton
          ...
          sx={getButtonStyle('/user/userRegister')}
        >
          <ListItemIcon>
            <PersonAddIcon sx={getIconStyle('/user/userRegister')} />
          </ListItemIcon>
        ...
        <ListItemButton
          ...
          sx={getButtonStyle('/tools/decommission')}
        >
          <ListItemIcon>
            <RemoveCircleOutlineIcon sx={getIconStyle('/tools/decommission')} />
          </ListItemIcon>
      ...
      <List>
        <ListItemButton
          ...
          sx={getButtonStyle('/tool/movementHistory')}
        >
          <ListItemIcon>
            <HistoryIcon sx={getIconStyle('/tool/movementHistory')} />
          </ListItemIcon>
        ...
        <ListItemButton
          ...
          sx={getButtonStyle('/loans/ActiveLoanList')}
        >
          <ListItemIcon>
            <AttachMoneyIcon sx={getIconStyle('/loans/ActiveLoanList')} />
          </ListItemIcon>
        ...
        <ListItemButton
          ...
          sx={getButtonStyle('/loans/unpaidLoans')}
        >
          <ListItemIcon>
            <MoneyOffIcon sx={getIconStyle('/loans/unpaidLoans')} />
          </ListItemIcon>
        ...
        <ListItemButton
          ...
          sx={getButtonStyle('/reports/lateClients')}
        >
          <ListItemIcon>
            <ReportProblemIcon sx={getIconStyle('/reports/lateClients')} />
          </ListItemIcon>
        ...
        <ListItemButton
          ...
          sx={getButtonStyle('/loans/TopTools')}
        >
          <ListItemIcon>
            <LeaderboardIcon sx={getIconStyle('/loans/TopTools')} />
          </ListItemIcon>
      ...
      <List>
        <ListItemButton onClick={() => navigate('/loans/list')} sx={getButtonStyle('/loans/list')}>
          <ListItemIcon>
            <ReceiptLongIcon sx={getIconStyle('/loans/list')} />
          </ListItemIcon>
        ...
        <ListItemButton onClick={() => navigate('/users/list')} sx={getButtonStyle('/users/list')}>
          <ListItemIcon>
            <GroupsIcon sx={getIconStyle('/users/list')} />
          </ListItemIcon>
