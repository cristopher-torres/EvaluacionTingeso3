  ...
  return (
    <LocalizationProvider dateAdapter={AdapterDayjs} adapterLocale="es">
      <Box sx={{ p: 3, bgcolor: '#0f172a', minHeight: '100vh' }}>
                ...
                slotProps={{
                  input: {
                    ...
                    endAdornment: (
                      <>
                        <Tooltip
                          title="Filtre todos los movimientos de una herramienta en particular"
                          arrow
                          placement="top"
                        >
                          <HelpOutlineIcon
        ...
        {error && (
          <Typography sx={{ color: '#f87171', mb: 2, fontWeight: 600 }}>{error}</Typography>
        )}
