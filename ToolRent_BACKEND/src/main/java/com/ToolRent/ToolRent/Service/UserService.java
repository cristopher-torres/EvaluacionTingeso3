...
public class UserService {
    ...
    public void checkActiveLoans(Long userId) {
        ...
        if (activeLoans >= 5) {
            throw new IllegalStateException("El usuario ya tiene 5 prestamos activos no puede tomar otro prestamo.");
        }
    }
    ...
    public void checkDuplicateToolLoan(Long userId, String toolName) {
        ...
        if (activeLoans >= 1) {
            throw new IllegalStateException("El usuario ya tiene el máximo de préstamos permitidos para esta herramienta");
        }
    }
